    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-neutral-100 to-neutral-200">
      <main className="flex flex-col max-w-2xl w-full mx-auto rounded-3xl shadow-2xl bg-white p-8 my-8">
        ...
        <p className="mb-2 text-gray-600">
          At EdgeAssist, we value your privacy and are committed to protecting
          your personal information. This Privacy Policy explains how we
          collect, use, disclose, and safeguard your information when you use
          our website and services, including services provided internationally.
        </p>
        ...
        <ul className="list-disc list-inside mb-4 text-gray-600">
          <li>
            ...
            payment information, which you provide when you register for our
            services or communicate with us.
          </li>
          <li>
            Project Information: Details related to the projects you submit,
            including specifications, requirements, and any other information
        ...
        <ul className="list-disc list-inside mb-4 text-gray-600">
          ...
          <li>
            To communicate with you, including sending updates and important
        ...
        <ul className="list-disc list-inside mb-4 text-gray-600">
          <li>
            ...
            individuals to facilitate our services, such as payment processors
            and email service providers. These third parties will only have
            access to your personal information to perform tasks on our behalf
        ...
        <p className="mb-2 text-gray-600">
          ...
          located outside India and choose to provide information to us, please
          note that we transfer the data, including personal information, to
          India and process it there. By providing your information, you consent
          to the transfer of your information to India and its use in accordance
